...
<div x-data="{ deleteId: null, deletepemasukan: null }" @confirm-delete.window="deleteId = $event.detail.id; deletepemasukan = $event.detail.pemasukan;">
    <div class="page-heading mb-4">
        <h3 class="text-2xl font-bold text-gray-800">Laporan</h3>
    </div>

    <div class="flex justify-end items-center mb-4">
        <a href="{{ route('createlaporan') }}" wire:navigate class="btn btn-primary">
            Tambah Laporan
        </a>
    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <button
                                                    ...
                                                    @click="
                                                        if(confirm('Hapus ' + '{{ addslashes($laporan->pemasukan) }}' + ' secara permanen?')) {
